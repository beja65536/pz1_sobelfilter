...
CONFIG.NUM_SI {1} \
  ...
  # Create instance: rgb_2_gray_0, and set properties
  set rgb_2_gray_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:rgb_2_gray:1.0 rgb_2_gray_0 ]

  # Create instance: rgb_2_gray_0_if, and set properties
  set rgb_2_gray_0_if [ create_bd_cell -type ip -vlnv xilinx.com:ip:axis_accelerator_adapter:2.1 rgb_2_gray_0_if ]
  set_property -dict [ list \
...
CONFIG.C_S_AXIS_TDATA_WIDTH {64} \
  ...
  # Create instance: sobel_filter_0_if, and set properties
  set sobel_filter_0_if [ create_bd_cell -type ip -vlnv xilinx.com:ip:axis_accelerator_adapter:2.1 sobel_filter_0_if ]
  set_property -dict [ list \
CONFIG.C_AP_IARG_0_DIM_1 {1024} \
CONFIG.C_AP_IARG_0_DWIDTH {8} \
CONFIG.C_AP_IARG_0_TYPE {1} \
...
CONFIG.NUM_PORTS {10} \
  ...
  connect_bd_intf_net -intf_net axi_ic_processing_system7_0_axi_periph_M06_AXI_M00_AXI [get_bd_intf_pins axi_ic_processing_system7_0_axi_periph_M06_AXI/M00_AXI] [get_bd_intf_pins rgb_2_gray_0_if/S_AXI]
  connect_bd_intf_net -intf_net axi_ic_processing_system7_0_axi_periph_M06_AXI_M01_AXI [get_bd_intf_pins axi_ic_processing_system7_0_axi_periph_M06_AXI/M01_AXI] [get_bd_intf_pins sobel_filter_0_if/S_AXI]
  connect_bd_intf_net -intf_net axi_ic_processing_system7_0_axi_periph_M06_AXI_M02_AXI [get_bd_intf_pins axi_ic_processing_system7_0_axi_periph_M06_AXI/M02_AXI] [get_bd_intf_pins dm_0/S_AXI_LITE]
  connect_bd_intf_net -intf_net axi_ic_processing_system7_0_axi_periph_M06_AXI_M03_AXI [get_bd_intf_pins axi_ic_processing_system7_0_axi_periph_M06_AXI/M03_AXI] [get_bd_intf_pins dm_1/S_AXI_LITE]
  connect_bd_intf_net -intf_net axi_ic_processing_system7_0_axi_periph_M06_AXI_M04_AXI [get_bd_intf_pins axi_ic_processing_system7_0_axi_periph_M06_AXI/M04_AXI] [get_bd_intf_pins dm_2/S_AXI_LITE]
  connect_bd_intf_net -intf_net axi_ic_processing_system7_0_axi_periph_M06_AXI_M05_AXI [get_bd_intf_pins axi_ic_processing_system7_0_axi_periph_M06_AXI/M05_AXI] [get_bd_intf_pins dm_3/S_AXI_LITE]
  ...
  connect_bd_intf_net -intf_net dm_0_M_AXIS_MM2S [get_bd_intf_pins dm_0/M_AXIS_MM2S] [get_bd_intf_pins rgb_2_gray_0_if/S_AXIS_0]
  ...
  connect_bd_intf_net -intf_net dm_1_M_AXIS_MM2S [get_bd_intf_pins dm_1/M_AXIS_MM2S] [get_bd_intf_pins sobel_filter_0_if/S_AXIS_0]
  connect_bd_intf_net -intf_net dm_1_M_AXI_MM2S [get_bd_intf_pins axi_ic_processing_system7_0_S_AXI_HP2/S01_AXI] [get_bd_intf_pins dm_1/M_AXI_MM2S]
  connect_bd_intf_net -intf_net dm_2_M_AXI_S2MM [get_bd_intf_pins axi_ic_processing_system7_0_S_AXI_HP2/S02_AXI] [get_bd_intf_pins dm_2/M_AXI_S2MM]
  connect_bd_intf_net -intf_net dm_3_M_AXI_S2MM [get_bd_intf_pins axi_ic_processing_system7_0_S_AXI_HP2/S03_AXI] [get_bd_intf_pins dm_3/M_AXI_S2MM]
  ...
  connect_bd_intf_net -intf_net rgb_2_gray_0_color [get_bd_intf_pins rgb_2_gray_0/color] [get_bd_intf_pins rgb_2_gray_0_if/AP_FIFO_IARG_0]
  connect_bd_intf_net -intf_net rgb_2_gray_0_gray [get_bd_intf_pins rgb_2_gray_0/gray] [get_bd_intf_pins rgb_2_gray_0_if/AP_FIFO_OARG_0]
  connect_bd_intf_net -intf_net rgb_2_gray_0_if_AP_CTRL [get_bd_intf_pins rgb_2_gray_0/ap_ctrl] [get_bd_intf_pins rgb_2_gray_0_if/AP_CTRL]
  connect_bd_intf_net -intf_net rgb_2_gray_0_if_M_AXIS_0 [get_bd_intf_pins dm_3/S_AXIS_S2MM] [get_bd_intf_pins rgb_2_gray_0_if/M_AXIS_0]
  ...
  connect_bd_intf_net -intf_net sobel_filter_0_if_AP_CTRL [get_bd_intf_pins sobel_filter_0/ap_ctrl] [get_bd_intf_pins sobel_filter_0_if/AP_CTRL]
  connect_bd_intf_net -intf_net sobel_filter_0_if_M_AXIS_0 [get_bd_intf_pins dm_2/S_AXIS_S2MM] [get_bd_intf_pins sobel_filter_0_if/M_AXIS_0]
  connect_bd_intf_net -intf_net sobel_filter_0_input_r [get_bd_intf_pins sobel_filter_0/input_r] [get_bd_intf_pins sobel_filter_0_if/AP_FIFO_IARG_0]
  connect_bd_intf_net -intf_net sobel_filter_0_output_r [get_bd_intf_pins sobel_filter_0/output_r] [get_bd_intf_pins sobel_filter_0_if/AP_FIFO_OARG_0]
  ...
  connect_bd_net -net dm_1_mm2s_introut [get_bd_pins dm_1/mm2s_introut] [get_bd_pins xlconcat_0/In7]
  connect_bd_net -net dm_2_s2mm_introut [get_bd_pins dm_2/s2mm_introut] [get_bd_pins xlconcat_0/In8]
  connect_bd_net -net dm_3_s2mm_introut [get_bd_pins dm_3/s2mm_introut] [get_bd_pins xlconcat_0/In9]
  connect_bd_net -net hdmi_out_hpd_video_gpio_io_o [get_bd_ports hdmi_out_hpd] [get_bd_pins hdmi/gpio_io_o]
  connect_bd_net -net proc_sys_reset_142M_interconnect_aresetn [get_bd_pins hdmi/ARESETN] [get_bd_pins proc_sys_reset_142M/interconnect_aresetn]
  connect_bd_net -net proc_sys_reset_142M_peripheral_aresetn [get_bd_pins hdmi/M00_ARESETN] [get_bd_pins proc_sys_reset_142M/peripheral_aresetn]
  connect_bd_net -net proc_sys_reset_200M_interconnect_aresetn [get_bd_pins axi_ic_processing_system7_0_S_AXI_HP2/ARESETN] [get_bd_pins axi_ic_processing_system7_0_S_AXI_HP2/M00_ARESETN] [get_bd_pins axi_ic_processing_system7_0_S_AXI_HP2/S00_ARESETN] [get_bd_pins axi_ic_processing_system7_0_S_AXI_HP2/S01_ARESETN] [get_bd_pins axi_ic_processing_system7_0_S_AXI_HP2/S02_ARESETN] [get_bd_pins axi_ic_processing_system7_0_S_AXI_HP2/S03_ARESETN] [get_bd_pins axi_ic_processing_system7_0_axi_periph_M06_AXI/ARESETN] [get_bd_pins axi_ic_processing_system7_0_axi_periph_M06_AXI/M00_ARESETN] [get_bd_pins axi_ic_processing_system7_0_axi_periph_M06_AXI/M01_ARESETN] [get_bd_pins axi_ic_processing_system7_0_axi_periph_M06_AXI/M02_ARESETN] [get_bd_pins axi_ic_processing_system7_0_axi_periph_M06_AXI/M03_ARESETN] [get_bd_pins axi_ic_processing_system7_0_axi_periph_M06_AXI/M04_ARESETN] [get_bd_pins axi_ic_processing_system7_0_axi_periph_M06_AXI/M05_ARESETN] [get_bd_pins axi_ic_processing_system7_0_axi_periph_M06_AXI/S00_ARESETN] [get_bd_pins proc_sys_reset_200M/interconnect_aresetn]
  connect_bd_net -net proc_sys_reset_200M_peripheral_aresetn [get_bd_pins dm_0/axi_resetn] [get_bd_pins dm_1/axi_resetn] [get_bd_pins dm_2/axi_resetn] [get_bd_pins dm_3/axi_resetn] [get_bd_pins proc_sys_reset_200M/peripheral_aresetn] [get_bd_pins processing_system7_0_axi_periph/M06_ARESETN] [get_bd_pins rgb_2_gray_0_if/m_axis_aresetn] [get_bd_pins rgb_2_gray_0_if/s_axi_aresetn] [get_bd_pins rgb_2_gray_0_if/s_axis_aresetn] [get_bd_pins sobel_filter_0_if/m_axis_aresetn] [get_bd_pins sobel_filter_0_if/s_axi_aresetn] [get_bd_pins sobel_filter_0_if/s_axis_aresetn]
  ...
  connect_bd_net -net processing_system7_0_FCLK_CLK1 [get_bd_pins hdmi/m_axi_s2mm_aclk] [get_bd_pins proc_sys_reset_142M/slowest_sync_clk] [get_bd_pins processing_system7_0/FCLK_CLK1] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK]
  connect_bd_net -net processing_system7_0_FCLK_CLK2 [get_bd_pins axi_ic_processing_system7_0_S_AXI_HP2/ACLK] [get_bd_pins axi_ic_processing_system7_0_S_AXI_HP2/M00_ACLK] [get_bd_pins axi_ic_processing_system7_0_S_AXI_HP2/S00_ACLK] [get_bd_pins axi_ic_processing_system7_0_S_AXI_HP2/S01_ACLK] [get_bd_pins axi_ic_processing_system7_0_S_AXI_HP2/S02_ACLK] [get_bd_pins axi_ic_processing_system7_0_S_AXI_HP2/S03_ACLK] [get_bd_pins axi_ic_processing_system7_0_axi_periph_M06_AXI/ACLK] [get_bd_pins axi_ic_processing_system7_0_axi_periph_M06_AXI/M00_ACLK] [get_bd_pins axi_ic_processing_system7_0_axi_periph_M06_AXI/M01_ACLK] [get_bd_pins axi_ic_processing_system7_0_axi_periph_M06_AXI/M02_ACLK] [get_bd_pins axi_ic_processing_system7_0_axi_periph_M06_AXI/M03_ACLK] [get_bd_pins axi_ic_processing_system7_0_axi_periph_M06_AXI/M04_ACLK] [get_bd_pins axi_ic_processing_system7_0_axi_periph_M06_AXI/M05_ACLK] [get_bd_pins axi_ic_processing_system7_0_axi_periph_M06_AXI/S00_ACLK] [get_bd_pins dm_0/m_axi_mm2s_aclk] [get_bd_pins dm_0/s_axi_lite_aclk] [get_bd_pins dm_1/m_axi_mm2s_aclk] [get_bd_pins dm_1/s_axi_lite_aclk] [get_bd_pins dm_2/m_axi_s2mm_aclk] [get_bd_pins dm_2/s_axi_lite_aclk] [get_bd_pins dm_3/m_axi_s2mm_aclk] [get_bd_pins dm_3/s_axi_lite_aclk] [get_bd_pins hdmi/RefClk] [get_bd_pins proc_sys_reset_200M/slowest_sync_clk] [get_bd_pins processing_system7_0/FCLK_CLK2] [get_bd_pins processing_system7_0/S_AXI_HP2_ACLK] [get_bd_pins processing_system7_0_axi_periph/M06_ACLK] [get_bd_pins rgb_2_gray_0/ap_clk] [get_bd_pins rgb_2_gray_0_if/aclk] [get_bd_pins rgb_2_gray_0_if/m_axis_aclk] [get_bd_pins rgb_2_gray_0_if/s_axi_aclk] [get_bd_pins rgb_2_gray_0_if/s_axis_aclk] [get_bd_pins sobel_filter_0/ap_clk] [get_bd_pins sobel_filter_0_if/aclk] [get_bd_pins sobel_filter_0_if/m_axis_aclk] [get_bd_pins sobel_filter_0_if/s_axi_aclk] [get_bd_pins sobel_filter_0_if/s_axis_aclk]
  ...
  connect_bd_net -net rgb_2_gray_0_if_aresetn [get_bd_pins rgb_2_gray_0/ap_rst_n] [get_bd_pins rgb_2_gray_0_if/aresetn]
  ...
  connect_bd_net -net sobel_filter_0_if_aresetn [get_bd_pins sobel_filter_0/ap_rst_n] [get_bd_pins sobel_filter_0_if/aresetn]
  ...
  create_bd_addr_seg -range 0x20000000 -offset 0x0 [get_bd_addr_spaces dm_1/Data_MM2S] [get_bd_addr_segs processing_system7_0/S_AXI_HP2/HP2_DDR_LOWOCM] SEG_processing_system7_0_HP2_DDR_LOWOCM
  create_bd_addr_seg -range 0x20000000 -offset 0x0 [get_bd_addr_spaces dm_2/Data_S2MM] [get_bd_addr_segs processing_system7_0/S_AXI_HP2/HP2_DDR_LOWOCM] SEG_processing_system7_0_HP2_DDR_LOWOCM
  create_bd_addr_seg -range 0x20000000 -offset 0x0 [get_bd_addr_spaces dm_3/Data_S2MM] [get_bd_addr_segs processing_system7_0/S_AXI_HP2/HP2_DDR_LOWOCM] SEG_processing_system7_0_HP2_DDR_LOWOCM
  ...
  create_bd_addr_seg -range 0x10000 -offset 0x40420000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs dm_2/S_AXI_LITE/Reg] SEG_dm_2_Reg
  create_bd_addr_seg -range 0x10000 -offset 0x40430000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs dm_3/S_AXI_LITE/Reg] SEG_dm_3_Reg
  ...
  create_bd_addr_seg -range 0x10000 -offset 0x43C30000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs rgb_2_gray_0_if/S_AXI/Reg] SEG_rgb_2_gray_0_if_Reg
  create_bd_addr_seg -range 0x10000 -offset 0x43C40000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs sobel_filter_0_if/S_AXI/Reg] SEG_sobel_filter_0_if_Reg
